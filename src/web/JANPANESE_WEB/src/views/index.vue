<template>
  <div class="big-box">
    <div class="img-box">
      ...
      >
        <img src="../assets/bgcolor.jpg" alt="" />
        <img v-for="item in src" :key="item" :src="item.img" alt="" />
        <img src="../assets/bgcolor.jpg" alt="" />
      </div>
    </div>
    <div class="arrowhead-box" ref="swiper">
      <span @click="last"><img src="../assets/zuo.jpg" alt="" style="height:50px ;width:50px"></span>
      <span @click="next"><img src="../assets/zuo.jpg" alt="" style="height:50px ;width:50px"></span>
    </div>
  ...
  data() {
    return {
      src: [
        ...
        { img: require("../assets/bgcolor.jpg") },
        { img: require("../assets/background.jpg") },
        { img: require("../assets/bgcolor.jpg") },
        { img: require("../assets/background.jpg") },
      ],
